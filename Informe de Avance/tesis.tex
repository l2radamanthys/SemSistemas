\documentclass[10pt,fleqn,twoside,openany]{book}
\topmargin=3cm
...
\include{objectivos}
\include{planteamiento_problema}
\include{estudio_factibilidad}
\include{metodologia}
\include{unidades_operacion}
\include{herramientas}
\include{investigacion_desarrollo}
